...
<div
  ...
  <div
    ...
    <p
      class="relative z-10 bg-gradient-to-t from-teal-400 to-blue-400 text-xl bg-clip-text text-transparent font-extrabold tracking-tight group-hover:text-white transition-colors">
      modinstaller
    </p>
    <div
